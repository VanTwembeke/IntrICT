  ...
  if (notFound || !profile) {
    return (
      <div className="min-h-screen bg-slate-50">
        <div className="px-4 py-20 mx-auto max-w-3xl text-center sm:px-6 lg:px-8">
          ...
          <Link href="/" className="inline-flex items-center px-5 py-3 mt-8 font-semibold text-white transition rounded-full bg-blue-600 hover:bg-blue-700">
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="px-4 py-12 mx-auto max-w-5xl sm:px-6 lg:px-8">
        ...
        <div className="mt-10 overflow-hidden bg-white border border-slate-200 shadow-sm rounded-3xl">
          <div className="relative px-6 py-10 sm:px-10 sm:py-12">
            ...
            <div className="relative grid gap-8 lg:grid-cols-[220px_minmax(0,1fr)] lg:items-center">
              <div className="flex items-center justify-center w-44 h-44 mx-auto overflow-hidden rounded-full bg-slate-100 shadow-lg lg:mx-0">
