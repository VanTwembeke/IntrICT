...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/u/VanTwembeke',
      icon: (
    ...
    {
      name: 'Instagram',
      href: 'https://instagram.com/intrict.9000',
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/profile.php?id=61572120638573',
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          <path d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047V9.413c0-3.025 1.791-4.697 4.533-4.697 1.313 0 2.686.236 2.686.236v2.971h-1.513c-1.491 0-1.956.93-1.956 1.884v2.266h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z" />
        </svg>
      ),
    },
  ];
