      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 py-16 md:py-24">
          <div className="w-full max-w-4xl px-6 mx-auto text-center">
            ...
            >
              Klaar om je digitale aanwezigheid naar het volgende niveau te tillen?
              Laten we bespreken hoe ik je kan helpen.
            </motion.p>
            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
              <motion.button
                ...
                className="flex items-center justify-center gap-2 w-full sm:w-auto px-8 py-3 text-base font-semibold transition-all duration-300 bg-white rounded-full shadow-2xl text-slate-800 hover:bg-slate-100"
              >
              ...
              <motion.button
                ...
                className="flex items-center justify-center gap-2 w-full sm:w-auto px-8 py-3 text-base font-semibold text-white transition-all duration-300 border-2 border-white rounded-full hover:bg-white hover:text-slate-800"
              >
                <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
