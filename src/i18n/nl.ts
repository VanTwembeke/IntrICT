const nl = {
  ...
  nav: {
    ...
    onsProces:  'Ons proces',
    onsProcesDesc: 'Hoe werken we samen?',
    portfolio:  'Portfolio',
    blog:       'Blog',
    over:       'Over',
    overIntrict: 'Over IntrICT',
    overIntrictDesc: 'Het verhaal achter IntrICT',
    onzeVisie:  'Onze visie',
  ...
  pricing: {
    ...
    subtitle: 'Eerlijke prijzen voor kwaliteitswerk. Geen verborgen kosten, gewoon duidelijke afspraken.',
    period:  'eenmalig',
    ...
    support: {
      heading:    'Extra Ondersteuning',
      subtitle:   'Na de ondersteuningsperiode kun je extra uren bij mij afnemen voor updates, aanpassingen of nieuwe functionaliteiten.',
      mostChosen: 'Meest Gekozen',
      vatNote:    'Alle prijzen zijn exclusief BTW. Heb je andere wensen?',
      talkLink:   'Laten we even praten \u2192',
      tiers: [
        {
          price: '\u20ac75', title: 'Standaard Tarief',
          desc:  'Voor kleine aanpassingen en updates',
          items: ['Kleine aanpassingen', 'Bug fixes', 'Content updates', 'Eenvoudige wijzigingen'],
        },
        {
          price: '\u20ac60', title: 'Bij 5+ Uren',
          desc:  'Korting bij 5 of meer uren per maand',
          items: ['Alle standaard werkzaamheden', 'Nieuwe functionaliteiten', 'Design aanpassingen', 'Performance optimalisatie'],
        },
        {
          price: '\u20ac50', title: 'Bij 10+ Uren',
          desc:  'Beste prijs bij 10 of meer uren per maand',
